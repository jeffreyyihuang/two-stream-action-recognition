...
def video_level_acc(dic_video_level_preds):
    ...
    #print video_level_labels, video_level_preds
    #top1 top5
    ...
    #top1 = float(correct)/float(len(dic_video_level_preds))
...
def validate(test_loader, Model, criterion, epoch, L_test_keys, BATCH_SIZE):
