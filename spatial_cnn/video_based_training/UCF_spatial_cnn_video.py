...
class Data_Loader():
    def __init__(self, BATCH_SIZE, num_workers, data_path, dic_path):
        ...
        self.training_set = UCF_training_set(dic=dic_training, dic_frame=dic_nb_frame, root_dir=self.data_path, transform = transforms.Compose([
